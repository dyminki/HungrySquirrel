...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function Game() {
    ...
    this.showSquirrel = function() {
      ...
      this.board[this.index(this.squirrel.x, this.squirrel.y)].classList.add(
        "squirrel"
      );
    };

    this.hideVisibleSquirrel = function() {
      document.querySelector(".squirrel") != null &&
        document.querySelector(".squirrel").classList.remove("squirrel");
    };

    this.showWalnut = function() {
      this.board[this.index(this.walnut.x, this.walnut.y)].classList.add(
        "walnut"
      );
    };
    ...
    this.checkWalnutCollision = function() {
      if (
        this.squirrel.y === this.walnut.y &&
        this.squirrel.x === this.walnut.x
      ) {
